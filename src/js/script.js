function searchUser() {
  ...
  axios.get(`https://api.github.com/users/${username}`)
    .then(response => {
      ...
      const name = userData.name || "Nome não informado";
      const bio = userData.bio || "Bio não informada";
      const company = userData.company || "Empresa não informada"
      const location = userData.location || "Localização não informada"
      const blog = userData.blog || "Blog não informado"
